...
namespace Xiidea\EasyGuiBundle\Util;
...
use Xiidea\EasyGuiBundle\Output\StringOutput;
use Xiidea\EasyGuiBundle\Formatter\HtmlConsoleOutputFormatter;

/**
 * Class CommandExecutor
 * @package Xiidea\EasyGuiBundle\Util
 */
class CommandExecutor
{
