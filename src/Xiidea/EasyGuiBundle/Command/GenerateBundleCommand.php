...
use Xiidea\EasyGuiBundle\Generator\BundleGenerator;
...
EOT
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$structure && $questionHelper->ask($input, $output, $question))
        {
            ...
            $question->setValidator(
                array('Xiidea\EasyGuiBundle\Command\GenerateBundleCommand', 'validateBundleTemplate')
            );
            $template = $questionHelper->ask($input, $output, $question);

            //$template = $dialog->askAndValidate($output, $dialog->getQuestion('Bundle template', $input->getOption('template-name')), array('Xiidea\EasyGuiBundle\Command\GenerateBundleCommand', 'validateBundleTemplate'), false, $input->getOption('template-name'));
