...
class FormGeneratorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $response = $this->render( 'XiideaEasyGuiBundle:FormElements:elements-panel.html.twig', array('elements' => $elements) );
    ...
    public function renderFormElementAjaxAction(Request $request)
    {
        ...
        $response = $this->render( 'XiideaEasyGuiBundle:FormElements/items:' . $name . '.html.twig', array('vars' => $vars) );
        $html = $response->getContent();
    ...
    public function renderAttributesFormAjaxAction(Request $request)
    {
        ...
        $response = $this->render( 'XiideaEasyGuiBundle:FormElements:attributes-form.html.twig', array('element' => $element, 'name' => $name) );
        $html = $response->getContent();
